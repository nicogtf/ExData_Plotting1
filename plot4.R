...
# 1st chart
with(df, plot(datetime, Global_active_power, type = 'l', xlab='', ylab = 'Global Active Power', main = ''))

# 2nd chart
with(df, plot(datetime, Voltage, type = 'l', xlab='datetime', ylab = 'Voltage', main = ''))
